 ...
 */
export function set_low_end_mode(enabled) {
    wasm.set_low_end_mode(enabled);
}
 ...
 * @param {number} mode
 */
export function set_performance_mode(mode) {
    wasm.set_performance_mode(mode);
}
 ...
 * @param {number} height
 */
export function wasm_init_canvas(width, height) {
    wasm.wasm_init_canvas(width, height);
}
 ...
 */
export function wasm_update_vu(buf) {
    const ptr0 = passArray8ToWasm0(buf, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.wasm_update_vu(ptr0, len0);
}
 ...
 * @param {boolean} down
 */
export function wasm_update_mouse(x, y, active, down) {
    wasm.wasm_update_mouse(x, y, active, down);
}

/**
 * @returns {number}
 */
export function frame_ptr() {
    const ret = wasm.frame_ptr();
    return ret >>> 0;
}
 ...
 * @returns {number}
 */
export function frame_len() {
    const ret = wasm.frame_len();
    return ret >>> 0;
}
 ...
 * @param {string} s
 */
export function wasm_set_screen_text(s) {
    const ptr0 = passStringToWasm0(s, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.wasm_set_screen_text(ptr0, len0);
}

export function wasm_render_frame() {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('alpine_lowend_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
